...
class Challenger4Image extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Challenger4Game(),
    );
  }
}

class Challenger4Game extends StatefulWidget {
  const Challenger4Game({Key? key}) : super(key: key);

  @override
  State<Challenger4Game> createState() => _Challenger4GameState();
}

class _Challenger4GameState extends State<Challenger4Game> {
    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          ...
          // Image "two.png" above the solution box
          SizedBox(
            width: 350,
            height: 200,
            child: Image.asset(
